...
app.config['MAIL_USERNAME'] = "devendrabishnoi881@gmail.com"
app.config['MAIL_PASSWORD'] = "aaauwdbkatzdhqhd"
...
def forgot():
    ...
    if response == "forgot":
        ...
        message = Message("Movify | OTP for password reset", sender="devendrabishnoi881@gmail.com", recipients=[signin_email])
